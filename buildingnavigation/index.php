...
//AND area != 0 
        ...
        ?>
        <div class="col-lg-3 col-md-3 col-sm-4 col-xs-5 col-xxs-6 card-col" data-title="<?php echo $building['name'] ?>" data-buildingtype="<?php echo $building['building_type'] ?>" data-consumption="<?php echo $meters[0]['current']?>">
  ...
  <div class="navbar">
      ...
      <div class="btn-group">
        ...
        <div class="dropdown">
          ...
          <span class="caret"></span></button>
          <ul class="dropdown-menu">
              <li> <a href="https://environmentaldashboard.org/oberlin/time-series/buildingnavigation/index.php">Alphabetical</a></li>
